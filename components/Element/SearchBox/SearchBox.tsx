...
import { SearchBoxContainer } from './index.styled';
...
export const SearchBox = ({ className }: SearchBoxProps) => {
	return (
		<SearchBoxContainer className={className}>
			...
			/>
			<button
				className="btn  px-6 py-2.5 bg-primary text-black font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"
				type="button"
				id="button-addon2"
			>
				<svg
